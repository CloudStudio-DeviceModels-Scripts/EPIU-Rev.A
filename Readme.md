...
# Configuration Script – EPIU - Rev. A

This **Configuration** script is designed for the **EPIU** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EPIU Rev. A

Este script de **Configuration** está diseñado para el modelo **EPIU** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
