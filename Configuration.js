...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("10", "temperatureBME", endpointType.temperatureSensor);
  endpoints.addEndpoint("11", "temperatureH22", endpointType.temperatureSensor);
  endpoints.addEndpoint("6", "humidityBME", endpointType.humiditySensor);
  endpoints.addEndpoint("7", "humidityH22", endpointType.humiditySensor);
  endpoints.addEndpoint("8", "ligthBH1750", endpointType.lightSensor);
  endpoints.addEndpoint("9", "pressureBME", endpointType.pressureSensor);
  endpoints.addEndpoint("1", "ADC0", endpointType.voltageSensor); 
  endpoints.addEndpoint("2", "ADC1", endpointType.currentSensor);
  endpoints.addEndpoint("3", "altitudeBME", endpointType.weightSensor);
  endpoints.addEndpoint("4", "bootCount", endpointType.peopleCounter);
  endpoints.addEndpoint("5", "gasConcentration", endpointType.ppmConcentrationSensor);
